...
Letter.prototype.step = function( ){
	if( this.reset ) {
		this.position.x -= this.position.x * 0.05;
		this.position.y -= this.position.y * 0.05;
	}
...
var Main = function( ) {
	...
	var els;
	if( Math.random() > 0.5 ) els = document.getElementsByClassName('k');
	else els = document.getElementsByClassName('e');
